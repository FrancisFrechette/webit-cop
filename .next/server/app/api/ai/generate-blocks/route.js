"use strict";(()=>{var e={};e.id=8443,e.ids=[8443],e.modules={72934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},54580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},45869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},92048:e=>{e.exports=require("fs")},32615:e=>{e.exports=require("http")},35240:e=>{e.exports=require("https")},55315:e=>{e.exports=require("path")},68621:e=>{e.exports=require("punycode")},76162:e=>{e.exports=require("stream")},17360:e=>{e.exports=require("url")},21764:e=>{e.exports=require("util")},6162:e=>{e.exports=require("worker_threads")},71568:e=>{e.exports=require("zlib")},3263:e=>{e.exports=import("firebase-admin/app")},79637:e=>{e.exports=import("firebase-admin/auth")},72929:e=>{e.exports=import("firebase-admin/firestore")},87561:e=>{e.exports=require("node:fs")},84492:e=>{e.exports=require("node:stream")},72477:e=>{e.exports=require("node:stream/web")},56582:(e,t,r)=>{r.a(e,async(e,n)=>{try{r.r(t),r.d(t,{originalPathname:()=>m,patchFetch:()=>l,requestAsyncStorage:()=>p,routeModule:()=>u,serverHooks:()=>x,staticGenerationAsyncStorage:()=>d});var a=r(49303),o=r(88716),i=r(60670),s=r(68021),c=e([s]);s=(c.then?(await c)():c)[0];let u=new a.AppRouteRouteModule({definition:{kind:o.x.APP_ROUTE,page:"/api/ai/generate-blocks/route",pathname:"/api/ai/generate-blocks",filename:"route",bundlePath:"app/api/ai/generate-blocks/route"},resolvedPagePath:"C:\\Projets - Developpement\\cursor-webit-cop\\app\\api\\ai\\generate-blocks\\route.ts",nextConfigOutput:"",userland:s}),{requestAsyncStorage:p,staticGenerationAsyncStorage:d,serverHooks:x}=u,m="/api/ai/generate-blocks/route";function l(){return(0,i.patchFetch)({serverHooks:x,staticGenerationAsyncStorage:d})}n()}catch(e){n(e)}})},68021:(e,t,r)=>{r.a(e,async(e,n)=>{try{r.r(t),r.d(t,{POST:()=>u});var a=r(90455),o=r(18027),i=r(26729),s=r(55717),c=r(87070),l=e([a]);async function u(e){let t;try{await (0,a.mk)()}catch{return c.NextResponse.json({error:"Non autoris\xe9"},{status:401})}try{t=await e.json()}catch{return c.NextResponse.json({error:"Body JSON invalide"},{status:400})}if(!t.types||!Array.isArray(t.types)||0===t.types.length)return c.NextResponse.json({error:"types doit \xeatre un tableau non vide"},{status:400});let r=(0,i.w)(t);try{let e;let t=(await o.w.messages.create({model:"claude-3-5-sonnet-20241022",max_tokens:1024,messages:[{role:"user",content:r}]})).content.map(e=>"text"in e?e.text:"").join("\n").trim();try{e=JSON.parse(t)}catch{e={blocks:[]}}Array.isArray(e.blocks)||(e={blocks:[]});let n=["hero","richText","faq","cta"],a=e.blocks.filter(e=>e&&"object"==typeof e&&"type"in e&&n.includes(e.type)).map((e,t)=>{let r=e.id??`ai-block-${t}`;return{...e,id:r}});return c.NextResponse.json({blocks:a})}catch(e){return e instanceof s.Hx?console.error("Claude generate-blocks error",e.status,e.message):console.error("Unexpected generate-blocks AI error",e),c.NextResponse.json({blocks:[]},{status:200})}}a=(l.then?(await l)():l)[0],n()}catch(e){n(e)}})},26729:(e,t,r)=>{function n(e){let{blocks:t,url:r,locale:n}=e,a=t.map((e,t)=>{switch(e.type){case"hero":return`Bloc #${t+1} (Hero): titre="${e.title}", sous-titre="${e.subtitle??""}"`;case"richText":return`Bloc #${t+1} (Texte riche): extrait="${e.html.slice(0,200)}"`;case"faq":return`Bloc #${t+1} (FAQ): ${e.items.length} questions (ex: "${e.items[0]?.question??""}")`;case"cta":return`Bloc #${t+1} (CTA): label="${e.label}", url="${e.url}"`;default:return`Bloc #${t+1} (type inconnu)`}}).join("\n");return`
