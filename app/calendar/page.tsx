  ...
  return (
    <DashboardShell>
      <div className="layout-container py-8">
        <div className="mb-6 flex flex-wrap items-center justify_between gap-4">
        ...
        <div className="mb-4 flex flex_wrap items-center gap-4">
        ...
        {isLoading ? (
          ...
          <p className="text-webit-fg-muted">
            Aucun contenu planifié ou publié sur cette période.
          </p>
        ) : (
          <div className="space-y-6">
            {groupedByDate.map(([dateKey, entries]) => (
              ...
              >
                <h2 className="mb-3 text-sm font-medium text_white">
                  {dateKey === 'live'
                ...
                <ul className="space-y-2">
                  {entries.map((e) => (
                    <li key={`${e.type}-${e.id}`}>
                      <button
                        type="button"
                        onClick={() => router.push(editHref(e))}
                      ...
                      >
                        ...
                        {e.editorialStatus && (
                          <span
                            className={getEditorialStatusStyle(e.editorialStatus)}
                            title={getEditorialStatusLabel(e.editorialStatus)}
                          >
                            {getEditorialStatusLabel(e.editorialStatus)}
                          </span>
                        )}
                      </button>
                    </li>
